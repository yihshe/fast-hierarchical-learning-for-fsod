...
class MetaLearner(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        """
        # TODO modify the cfg file accordingly for meta training of the novel predictor
        ...
        # TODO rts the weights can be randini here, model weights reset_remove
    ...
    def build_task_batch(self):
        ...
        meta_task_samples = self.task_sampler.generate_tasks(scope='novel')
        task_set_names = self.task_sampler.register_tasks(meta_task_samples)
        tasks = self.task_dataset.build_tasks(task_set_names, meta_task_type='coco_meta_novel')
        # print('tasks')
        # embed()
        return tasks
