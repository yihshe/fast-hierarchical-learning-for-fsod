...
class MetaCGTrainer(TrainerBase):
    ...
    def init_model(cls, model, randinit_params):
        # TODO rts adapt it to the RTS novel predictor cosine output layers
    ...
    def build_optimizer(cls, cfg, model, problem, novel_init_weights, IDMAP, NOVEL_CLASSES):
        ...
        """
        # TODO clean the uncessary hooks and metrics in the optimizer
        # and modify the gradient tracking for calculation graph
