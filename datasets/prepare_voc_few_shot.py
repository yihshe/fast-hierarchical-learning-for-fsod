...
# 20 classes to sample the shots
...
def parse_args():
    ...
    # range of random seeds, based on which the shots are sampled
...
def generate_seeds(args):
    ...
    # shots to sample based on each random seed
    shots = [1, 2, 3, 5, 10]
    for i in range(args.seeds[0], args.seeds[1]):
        ...
        # path to save the sampled shots
